...
namespace POS.Item
{
    public partial class TransferInMaster : Form
    {
        private TransferInLayer layer = new TransferInLayer();
        ...
        private TransferInMain owner;
        private TransferInOrderModel Model;
        ...
        public TransferInMaster(TransferInMain _owner, string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (TransferInMain)_owner;
            txtdate.Value = DateTime.Now;
            txtcode.Select();
        }

        public TransferInMaster(TransferInMain _owner, string save, TransferInOrderModel model,AccountTempModel account)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (TransferInMain)_owner;
            Model = (TransferInOrderModel)model;
        ...
        private void GetProperty()
        {
            ...
            txtmaincode.Text = Model.Transfer_In_ID.ToString();
            ...
            List<TransferInInvoiceTempList> li = layer.LoadInvoiceDataGrid(Model.Transfer_In_ID);
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "دننه د انتقال بیل";
        ...
        private TransferInInvoiceModel SetInvoiceProperty(int i)
        {
            TransferInInvoiceModel model = new TransferInInvoiceModel();
        ...
        private TransferInAccountModel SetAccountProperty(int txtmaincode,string txtcode,DateTime date,string type,decimal amount,decimal recieved )
        {
            ...
            model.Transfer_In_ID = txtmaincode;
            model.Transfer_Out_ID = 0;
        ...
        //This variable for the storing tp in invoice
        ...
        internal void LoadDataForprint(string fromform,string p)
        {
            ...
            switch (p)
            {
                ...
                case "Preview":
                   TransferInReportForm obj = new TransferInReportForm(ds);
                    obj.Show();
                    break;
                case "Print":
                    TransferInOtherReport obj2 = new TransferInOtherReport(p, ds);
                    break;
                case "Word":
                    TransferInOtherReport obj3 = new TransferInOtherReport(p, ds);
                    break;
                case "Excel":
                    TransferInOtherReport obj4 = new TransferInOtherReport(p, ds);
                    break;
