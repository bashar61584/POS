...
namespace POS.Item
{
    class TransferOutOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\TransferOutInvoice.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\TransferOutInvoice.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\TransferOutInvoice.xls";
        DataSet1 ds;
        public TransferOutOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp;
