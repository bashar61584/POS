...
namespace POS.Item
{
    class SaleReturnOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleReturnInvoice.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleReturnInvoice.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleReturnInvoice.xls";
        DataSet1 ds;
        public SaleReturnOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp;
