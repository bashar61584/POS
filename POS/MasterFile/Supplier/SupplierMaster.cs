...
namespace POS.Item
{
    ...
    {
        private SupplierLayer layer = new SupplierLayer();
        ...
        private SupplierMain owner;     
        private SupplierModel Model;
        private string saveupdate { get; set; }

        public SupplierMaster(SupplierMain _owner,string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (SupplierMain)_owner;
            txtname.Select();
        }
        
        public SupplierMaster(SupplierMain _owner, string save,SupplierModel model)
        { 
            InitializeComponent();
            saveupdate = save;
            owner = (SupplierMain)_owner;
        ...
        {
            txtcode.Text = Model.Sup_ID.ToString();
