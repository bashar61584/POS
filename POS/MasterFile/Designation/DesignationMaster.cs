...
namespace POS.Item
{
    ...
    {
        private DesignationLayer layer = new DesignationLayer();
        ...
        private DesignationMain owner;     
        private DesignationModel itemModel;
        private string saveupdate { get; set; }

        public DesignationMaster(DesignationMain _owner,string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (DesignationMain)_owner;
            txtname.Select();
        }
        
        public DesignationMaster(DesignationMain _owner, string save,DesignationModel model)
        { 
            InitializeComponent();
            saveupdate = save;
            owner = (DesignationMain)_owner;
            itemModel = (DesignationModel)model;
        ...
        private void GetProperty()
        {
            ...
            txtcode.Text = itemModel.DSIG_ID.ToString();
