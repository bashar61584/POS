...
namespace POS.Item
{
    public partial class DesignationMain : Form 
    {
        readonly DesignationLayer layer = new DesignationLayer();
        DataTable dt = new DataTable();
        private string decession = "";
        public DesignationMain()
        {
            InitializeComponent();
            txtsearch.Select();
        }
        public DesignationMain(string dec)
        {
            InitializeComponent();
            txtsearch.Select();
            this.decession = dec;
        ...
        {
            DesignationMaster item = new DesignationMaster(this,"Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                    DesignationMaster item = new DesignationMaster(this, "Update", SetProperty());
                item.ShowDialog();
            }
        }
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د تشییدو لیست";
            this.Text = "د تشییدو لیست";
        }
        ...
        private DesignationModel SetProperty()
        {
            DesignationModel model = new DesignationModel();
            model.DSIG_ID = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells[0].Value.ToString());
