...
namespace POS.Item
{
    public partial class SaleMaster : Form
    {
        private SaleLayer layer = new SaleLayer();
        ...
        public SaleMaster(SaleMain _owner, string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (SaleMain)_owner;
            txtdate.Value = DateTime.Now;
            txtcode.Select();
        }

        public SaleMaster(SaleMain _owner, string save, SaleOrderModel model,AccountTempModel account)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (SaleMain)_owner;
            Model = (SaleOrderModel)model;
        ...
        private void GetProperty()
        {
            ...
            txtmaincode.Text = Model.Sale_Order_ID.ToString();
            ...
            List<SaleInvoiceTempList> li = layer.LoadInvoiceDataGrid(Model.Sale_Order_ID);
        ...
        private void ConvertLanguage()
        {
            ...
            lbldiscountper.Text = Language.Discountper;
            lbldiscountper.Font = Language.font;
            ...
            lbltitle.Text = "د خرڅلاو بیل جوړول";
        ...
        private SaleOrderModel SetProperty()
        {
        ...
        private SaleInvoiceModel SetInvoiceProperty(int i)
        {
        ...
        private SaleAccountModel SetAccountProperty(int txtmaincode,string txtcode,DateTime date,string type,decimal amount,decimal recieved )
        {
            ...
            model.Sale_Order_ID = txtmaincode;
            model.Sale_Return_ID = 0;
        ...
        internal void LoadDataForprint(string fromform,string p)
        {
            ...
            switch (p)
            {
                ...
                case "Preview":
                   SaleReportForm obj = new SaleReportForm(ds);
                    obj.Show();
                    break;
                case "Print":
                    SaleOtherReport obj2 = new SaleOtherReport(p, ds);
                    break;
                case "Word":
                    SaleOtherReport obj3 = new SaleOtherReport(p, ds);
                    break;
                case "Excel":
                    SaleOtherReport obj4 = new SaleOtherReport(p, ds);
                    break;
