...
namespace POS.Item
{
    class SupplierAccountOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SupplierAccount.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SupplierAccount.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SupplierAccount.xls";
        DataSet1 ds;
        public SupplierAccountOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp;
