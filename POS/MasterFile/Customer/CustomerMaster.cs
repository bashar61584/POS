...
namespace POS.Item
{
    ...
    {
        private CustomerLayer layer = new CustomerLayer();
        ...
        private CustomerMain owner;     
        private CustomerModel Model;
        private string saveupdate { get; set; }

        public CustomerMaster(CustomerMain _owner,string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (CustomerMain)_owner;
            txtname.Select();
        }
        
        public CustomerMaster(CustomerMain _owner, string save,CustomerModel model)
        { 
            InitializeComponent();
            saveupdate = save;
            owner = (CustomerMain)_owner;
        ...
        {
            txtcode.Text = Model.Cu_ID.ToString();
        ...
        private void ConvertLanguage()
        {
            ...
            lblwebiste.Text = Language.Website;
            lblwebiste.Font = Language.font;
