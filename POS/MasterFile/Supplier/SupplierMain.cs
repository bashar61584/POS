...
namespace POS.Item
{
    ...
    {
        readonly SupplierLayer layer = new SupplierLayer();
        ...
        public SupplierMain(string dec)
        {
            InitializeComponent();
            txtsearch.Select();
            this.decession = dec;
        ...
        {
            if (POS.Properties.Settings.Default.supplierlist)
            {
                SupplierMaster item = new SupplierMaster(this, "Save");
                item.ShowDialog();
            }
            else
            {
        ...
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            if (POS.Properties.Settings.Default.supplierlist)
            {
                if (bunifuCustomDataGrid1.RowCount != 1)
                    ...
                    {
                        SupplierMaster item = new SupplierMaster(this, "Update", SetProperty());
                        item.ShowDialog();
                    }
            }
            else
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د اکمالاتو لیست";
            this.Text = "د اکمالاتو لیست";
        }
        ...
        private SupplierModel SetProperty()
        {
            SupplierModel model = new SupplierModel();


            model.Sup_ID = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells[0].Value.ToString());
