...
namespace POS.Item
{
    class UserOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\User.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\User.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\User.xls";
        DataSet1 ds;
        public UserOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp; 
