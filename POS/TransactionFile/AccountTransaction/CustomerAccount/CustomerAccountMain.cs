...
namespace POS.Item
{
    public partial class CustomerAccountMain : Form 
    {
        readonly CustomerAccountLayer layer = new CustomerAccountLayer();
        DataTable dt = new DataTable();
        public CustomerAccountMain()
        {
            InitializeComponent();
            txtsearch.Select();
        }
        ...
        {
            CustomerAccountMaster item = new CustomerAccountMaster(this, "Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            if (bunifuCustomDataGrid1.RowCount != 1)
                ...
                {
                    CustomerAccountMaster item = new CustomerAccountMaster(this, "Update", SetProperty());
                    item.ShowDialog();
                }
        }
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د پیرودونکی د حساب لیست";
            this.Text = "د پیرودونکی د حساب لیست";
        }
