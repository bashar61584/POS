...
namespace POS.Item
{
    public partial class TransferOutMain : Form 
    {
        readonly TransferOutLayer layer = new TransferOutLayer();
        DataTable dt = new DataTable();
        AccountTempModel account;
        public TransferOutMain()
        {
            InitializeComponent();
            txtsearch.Select();
        }
        ...
        {
            TransferOutMaster item = new TransferOutMaster(this, "Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                TransferOutMaster item = new TransferOutMaster(this, "Update", SetProperty(), account);
                item.ShowDialog();
            }
        }
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "بهر ته د لیږد لړلیک";
            this.Text = "بهر ته د لیږد لړلیک";
        }
        ...
        private TransferOutOrderModel SetProperty()
        {
            ...
            model.Transfer_Out_ID = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells[0].Value.ToString());
            ...
            model.InvoiceNo= bunifuCustomDataGrid1.SelectedRows[0].Cells[3].Value.ToString();
            model.Date = Convert.ToDateTime(bunifuCustomDataGrid1.SelectedRows[0].Cells[4].Value.ToString());
            account.Credit= Convert.ToDecimal(bunifuCustomDataGrid1.SelectedRows[0].Cells[5].Value.ToString());
