...
namespace POS.Item
{
    ...
    {
        readonly EmployeeLayer layer = new EmployeeLayer();
        ...
        public EmployeeMain(string dec)
        {
            InitializeComponent();
            txtsearch.Select();
            this.decession = dec;
        ...
        {
            EmployeeMaster item = new EmployeeMaster(this,"Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                    EmployeeMaster item = new EmployeeMaster(this, "Update", SetProperty());
                item.ShowDialog();
            }
        }
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د کاروونی لیست";
            this.Text = "د کاروونی لیست";
        } 
        internal void LoadDataGridView(string state)
        {
            ...
            bunifuCustomDataGrid1.Columns["Desig_ID"].Visible = false;
        }
        ...
        private EmployeeModel SetProperty()
        {
            ...
            model.EMP_ID = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells[0].Value.ToString());
            ...
            model.NICNO = bunifuCustomDataGrid1.SelectedRows[0].Cells[6].Value.ToString();
            model.email = bunifuCustomDataGrid1.SelectedRows[0].Cells[7].Value.ToString();
            model.BasicSalary = Convert.ToDecimal(bunifuCustomDataGrid1.SelectedRows[0].Cells[8].Value.ToString());
            ...
            desigmodel.DSIG_ID = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells["Desig_ID"].Value.ToString());
            model.AddDate = Convert.ToDateTime(bunifuCustomDataGrid1.SelectedRows[0].Cells[15].Value.ToString());

            model.DesignationModels = desigmodel;
            return model;
        }
