...
namespace POS.Item
{
    public partial class SaleMain : Form 
    {
        readonly SaleLayer layer = new SaleLayer();
        ...
        {
            SaleMaster item = new SaleMaster(this, "Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                SaleMaster item = new SaleMaster(this, "Update", SetProperty(), account);
                item.ShowDialog();
            }
        }
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د خرڅلاو بیل لیست";
            this.Text = "د خرڅلاو بیل لیست";
        }
        ...
        private SaleOrderModel SetProperty()
        {
            ...
            model.Sale_Order_ID = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells[0].Value.ToString());
