...
namespace POS.Item
{
    public partial class LoanAccountMain : Form 
    {
        readonly LoanAccountLayer layer = new LoanAccountLayer();
        DataTable dt = new DataTable();
        public LoanAccountMain()
        {
            InitializeComponent();
            txtsearch.Select();
        }
        ...
        {
            LoanAccountMaster item = new LoanAccountMaster(this, "Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            if (bunifuCustomDataGrid1.RowCount != 1)
                ...
                {
                    LoanAccountMaster item = new LoanAccountMaster(this, "Update", SetProperty());
                    item.ShowDialog();
                }
        }
