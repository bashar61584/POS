...
namespace POS.Item
{
    public partial class PurchaseReturnMaster : Form
    {
        private PurchaseReturnLayer layer = new PurchaseReturnLayer();
        ...
        private PurchaseReturnMain owner;
        private PurchaseReturnOrderModel Model;
        ...
        public PurchaseReturnMaster(PurchaseReturnMain _owner, string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (PurchaseReturnMain)_owner;
            txtdate.Value = DateTime.Now;
            txtcode.Select();
        }

        public PurchaseReturnMaster(PurchaseReturnMain _owner, string save, PurchaseReturnOrderModel model,AccountTempModel account)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (PurchaseReturnMain)_owner;
            Model = (PurchaseReturnOrderModel)model;
        ...
        private void GetProperty()
        {
            ...
            txtmaincode.Text = Model.Purchase_ret_ID.ToString();
            ...
            List<PurchaseReturnInvoiceTempList> li = layer.LoadInvoiceDataGrid(Model.Purchase_ret_ID);
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د پیرودلو د بیرته راستنیدو بیل";
        ...
        private PurchaseReturnInvoiceModel SetInvoiceProperty(int i)
        {
            PurchaseReturnInvoiceModel model = new PurchaseReturnInvoiceModel();
        ...
        private PurchaseAccountModel SetAccountProperty(int txtmaincode,string txtcode,DateTime date,string type,decimal amount,decimal recieved )
        {
            ...
            model.Purchase_ret_ID = txtmaincode;
        ...
        internal void LoadDataForprint(string fromform,string p)
        {
            ...
            switch (p)
            {
                ...
                case "Preview":
                   PurchaseReturnReportForm obj = new PurchaseReturnReportForm(ds);
                    obj.Show();
                    break;
                case "Print":
                    PurchaseReturnOtherReport obj2 = new PurchaseReturnOtherReport(p, ds);
                    break;
                case "Word":
                    PurchaseReturnOtherReport obj3 = new PurchaseReturnOtherReport(p, ds);
                    break;
                case "Excel":
                    PurchaseReturnOtherReport obj4 = new PurchaseReturnOtherReport(p, ds);
                    break;
