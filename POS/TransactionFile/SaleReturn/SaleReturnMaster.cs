...
namespace POS.Item
{
    public partial class SaleReturnMaster : Form
    {
        private SaleReturnLayer layer = new SaleReturnLayer();
        ...
        private SaleReturnMain owner;
        private SaleReturnOrderModel Model;
        ...
        public SaleReturnMaster(SaleReturnMain _owner, string save)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (SaleReturnMain)_owner;
            txtdate.Value = DateTime.Now;
            txtcode.Select();
        }

        public SaleReturnMaster(SaleReturnMain _owner, string save, SaleReturnOrderModel model,AccountTempModel account)
        {
            InitializeComponent();
            saveupdate = save;
            owner = (SaleReturnMain)_owner;
            Model = (SaleReturnOrderModel)model;
        ...
        {
            txtcode.Text = Model.CustomerModels.Cu_ID.ToString();
            txtname.Text = Model.CustomerModels.Name;
            txtaddress.Text = Model.CustomerModels.Address1;
            txtphone.Text = Model.CustomerModels.phone1;
            txtmaincode.Text = Model.Sale_Return_ID.ToString();
            ...
            List<SaleReturnInvoiceTempList> li = layer.LoadInvoiceDataGrid(Model.Sale_Return_ID);
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د خرڅلاو د بیرته راستنیدو بیل جوړول";
        ...
        private SaleReturnOrderModel SetProperty()
        {
            ...
            model.Cu_ID = Convert.ToInt32(txtcode.Text);
        ...
        private SaleReturnInvoiceModel SetInvoiceProperty(int i)
        {
            SaleReturnInvoiceModel model = new SaleReturnInvoiceModel();
        ...
        private SaleAccountModel SetAccountProperty(int txtmaincode,string txtcode,DateTime date,string type,decimal amount,decimal recieved )
        {
            SaleAccountModel model = new SaleAccountModel();
            model.Sale_Order_ID = 0;
            model.Sale_Return_ID = txtmaincode;
        ...
        private bool CheckEmpty()
        {
            ...
            if (txtcode.Text == string.Empty)
            {
                MessageBox.Show("Customer Selection " + m);
                txtcode.Focus();
                return false;
            }
        ...
        internal void LoadDataForprint(string fromform,string p)
        {
            ...
            switch (p)
            {
                ...
                case "Preview":
                   SaleReturnReportForm obj = new SaleReturnReportForm(ds);
                    obj.Show();
                    break;
                case "Print":
                    SaleReturnOtherReport obj2 = new SaleReturnOtherReport(p, ds);
                    break;
                case "Word":
                    SaleReturnOtherReport obj3 = new SaleReturnOtherReport(p, ds);
                    break;
                case "Excel":
                    SaleReturnOtherReport obj4 = new SaleReturnOtherReport(p, ds);
                    break;
