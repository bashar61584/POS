...
namespace POS.Item
{
    class SaleOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleInvoice.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleInvoice.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleInvoice.xls";
        DataSet1 ds;
        public SaleOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp;
