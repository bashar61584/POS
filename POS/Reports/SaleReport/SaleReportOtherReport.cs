...
namespace POS.Item
{
    class SaleReportOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleReport.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleReport.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\SaleReport.xls";
        DataSet1 ds;
        public DateTime fromdate { get; set; }
        public DateTime todate { get; set; }

        public SaleReportOtherReport(string p ,DataSet s, DateTime fromd, DateTime tod)
        {
            ds = (DataSet1)s;
            fromdate = fromd;
            todate = tod;
