...
namespace POS.Item
{
    class EmployeePaymentOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\EmployeePayment.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\EmployeePayment.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\EmployeePayment.xls";
        DataSet1 ds;
        public EmployeePaymentOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp; 
