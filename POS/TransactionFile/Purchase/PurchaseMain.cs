...
namespace POS.Item
{
    ...
    {
        readonly PurchaseLayer layer = new PurchaseLayer();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            PurchaseMaster item = new PurchaseMaster(this, "Save");
            item.ShowDialog();
        }
        private void BtnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                PurchaseMaster item = new PurchaseMaster(this, "Update", SetProperty(), account);
                item.ShowDialog();
            }
        }
        ...
        private void ConvertLanguage()
        {
            ...
            lbltitle.Text = "د پیرودلو لیست";
            this.Text= "د پیرودلو لیست";
        ...
        private PurchaseOrderModel SetProperty()
        {
            ...
            model.purchase_order_id = Convert.ToInt32(bunifuCustomDataGrid1.SelectedRows[0].Cells[0].Value.ToString());
            ...
            account.Debit= Convert.ToDecimal(bunifuCustomDataGrid1.SelectedRows[0].Cells[7].Value.ToString());
