...
{
    public partial class LoanLedgerReportForm : Form
    {
        DateTime fromDate;
        DateTime toDate;
        decimal debit;
        ...
        private void CustomerReportForm_Load(object sender, EventArgs e)
        {
            if (POS.Properties.Settings.Default.Language == 1)
                rp2 = new LoanLedgerReportPashtu();
            else
                rp2 = new LoanLedgerReport();
