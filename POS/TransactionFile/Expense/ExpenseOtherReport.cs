...
namespace POS.Item
{
    class ExpenseOtherReport
    {
        private string FilePath = @"C:\users\" + Environment.UserName.ToString() + @"\documents\ExpenseInvoice.doc";
        private string FilePathEmail = @"C:\users\" + Environment.UserName.ToString() + @"\documents\ExpenseInvoice.pdf";
        private string FilePathExcel = @"C:\users\" + Environment.UserName.ToString() + @"\documents\ExpenseInvoice.xls";
        DataSet1 ds;
        public ExpenseOtherReport(string p,DataSet s)
        {
            ds = (DataSet1)s;
            ReportClass rp;
